...
-- 연습용
DROP TABLE attr_mini CASCADE CONSTRAINT;

CREATE TABLE attr_mini
(
attr_id number NOT NULL,
att_max number NOT NULL,
attr_time number NOT NULL,
...
SELECT  * FROM attr_mini;


INSERT ALL
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (1,13,10,'어린이번지드롭',	'http://adventure.lotteworld.com/image/2018/6/20180620073834101_275.jpg')
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (2,28,10,'실내롤러코스터',	'http://adventure.lotteworld.com/image/2018/6/20180619103158398_275.jpg')
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (3,56,20,'바이킹','http://adventure.lotteworld.com/image/2018/7/201807251058248710_275.jpg')
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (4,4,60,'사진관',	'http://adventure.lotteworld.com/image/2019/9/201909061114206600_275.jpg')
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (5,6,30,'풍선비행','http://adventure.lotteworld.com/image/2018/6/20180620074206373_275.jpg')
	INTO attr_mini (attr_id, att_max, attr_time, attr_name, attr_img)
		VALUES (6,50,15,'회전목마','http://adventure.lotteworld.com/image/2018/6/20180619090610881_275.jpg')
SELECT * FROM DUAL;
